...
{
  new (message_memory) map_if::srv::Command_Request(_init);
}

void Command_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<map_if::srv::Command_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Command_Request_message_member_array[1] = {
  {
    ...
    offsetof(map_if::srv::Command_Request, cmd),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Command_Request_message_members = {
  "map_if::srv",  // message namespace
  "Command_Request",  // message name
  1,  // number of fields
  sizeof(map_if::srv::Command_Request),
...
{
  return &::map_if::srv::rosidl_typesupport_introspection_cpp::Command_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, map_if, srv, Command_Request)() {
  return &::map_if::srv::rosidl_typesupport_introspection_cpp::Command_Request_message_type_support_handle;
}
...
void Command_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) map_if::srv::Command_Response(_init);
}

void Command_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<map_if::srv::Command_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Command_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(map_if::srv::Command_Response, result),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Command_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(map_if::srv::Command_Response),
...
{
  return &::map_if::srv::rosidl_typesupport_introspection_cpp::Command_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, map_if, srv, Command_Response)() {
  return &::map_if::srv::rosidl_typesupport_introspection_cpp::Command_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Command_service_members = {
  "map_if::srv",  // service namespace
  "Command",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<map_if::srv::Command>()
...
get_service_type_support_handle<map_if::srv::Command>()
{
  ...
  auto service_type_support =
    &::map_if::srv::rosidl_typesupport_introspection_cpp::Command_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, map_if, srv, Command)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<map_if::srv::Command>();
}
