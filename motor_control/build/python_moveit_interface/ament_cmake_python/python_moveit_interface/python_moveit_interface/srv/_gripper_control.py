...
class Metaclass_GripperControl(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'python_moveit_interface.srv.GripperControl')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from python_moveit_interface.srv import _gripper_control
...
class GripperControl(metaclass=Metaclass_GripperControl):
    from python_moveit_interface.srv._gripper_control import GripperControl_Request as Request
    from python_moveit_interface.srv._gripper_control import GripperControl_Response as Response
