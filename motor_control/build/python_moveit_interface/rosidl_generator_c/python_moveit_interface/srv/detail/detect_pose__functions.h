...
#ifndef PYTHON_MOVEIT_INTERFACE__SRV__DETAIL__DETECT_POSE__FUNCTIONS_H_
#define PYTHON_MOVEIT_INTERFACE__SRV__DETAIL__DETECT_POSE__FUNCTIONS_H_
...
/// Initialize srv/DetectPose message.
/**
...
/// Finalize srv/DetectPose message.
/**
...
/// Create srv/DetectPose message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * python_moveit_interface__srv__DetectPose_Request__init().
...
/// Destroy srv/DetectPose message.
/**
 * It calls
 * python_moveit_interface__srv__DetectPose_Request__fini()
...
/// Check for srv/DetectPose message equality.
/**
...
/// Initialize array of srv/DetectPose messages.
/**
...
/// Finalize array of srv/DetectPose messages.
/**
 * It calls
 * python_moveit_interface__srv__DetectPose_Request__fini()
...
/// Create array of srv/DetectPose messages.
/**
 * It allocates the memory for the array and calls
 * python_moveit_interface__srv__DetectPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/DetectPose messages.
/**
 * It calls
 * python_moveit_interface__srv__DetectPose_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/DetectPose message array equality.
/**
...
/// Copy an array of srv/DetectPose messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * python_moveit_interface__srv__DetectPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_python_moveit_interface
...
/**
 * It calls
 * python_moveit_interface__srv__DetectPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_python_moveit_interface
...
/**
 * It allocates the memory for the array and calls
 * python_moveit_interface__srv__DetectPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_python_moveit_interface
...
/**
 * It calls
 * python_moveit_interface__srv__DetectPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PYTHON_MOVEIT_INTERFACE__SRV__DETAIL__DETECT_POSE__FUNCTIONS_H_
