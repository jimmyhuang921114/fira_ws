...
python_moveit_interface__srv__PoseRequest_Request__init(python_moveit_interface__srv__PoseRequest_Request * msg)
{
  ...
  if (!geometry_msgs__msg__Pose__init(&msg->target_pose)) {
    python_moveit_interface__srv__PoseRequest_Request__fini(msg);
    return false;
  }
  // message
...
python_moveit_interface__srv__PoseRequest_Request__create()
{
  ...
  python_moveit_interface__srv__PoseRequest_Request * msg = (python_moveit_interface__srv__PoseRequest_Request *)allocator.allocate(sizeof(python_moveit_interface__srv__PoseRequest_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(python_moveit_interface__srv__PoseRequest_Request));
  bool success = python_moveit_interface__srv__PoseRequest_Request__init(msg);
  if (!success) {
...
python_moveit_interface__srv__PoseRequest_Request__Sequence__init(python_moveit_interface__srv__PoseRequest_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  python_moveit_interface__srv__PoseRequest_Request * data = NULL;

  if (size) {
    data = (python_moveit_interface__srv__PoseRequest_Request *)allocator.zero_allocate(size, sizeof(python_moveit_interface__srv__PoseRequest_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = python_moveit_interface__srv__PoseRequest_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        python_moveit_interface__srv__PoseRequest_Request__fini(&data[i - 1]);
      }
...
python_moveit_interface__srv__PoseRequest_Request__Sequence__fini(python_moveit_interface__srv__PoseRequest_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      python_moveit_interface__srv__PoseRequest_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  python_moveit_interface__srv__PoseRequest_Request__Sequence * array = (python_moveit_interface__srv__PoseRequest_Request__Sequence *)allocator.allocate(sizeof(python_moveit_interface__srv__PoseRequest_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = python_moveit_interface__srv__PoseRequest_Request__Sequence__init(array, size);
  if (!success) {
...
python_moveit_interface__srv__PoseRequest_Request__Sequence__destroy(python_moveit_interface__srv__PoseRequest_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    python_moveit_interface__srv__PoseRequest_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
python_moveit_interface__srv__PoseRequest_Request__Sequence__are_equal(const python_moveit_interface__srv__PoseRequest_Request__Sequence * lhs, const python_moveit_interface__srv__PoseRequest_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!python_moveit_interface__srv__PoseRequest_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  python_moveit_interface__srv__PoseRequest_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(python_moveit_interface__srv__PoseRequest_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    python_moveit_interface__srv__PoseRequest_Request * data =
      (python_moveit_interface__srv__PoseRequest_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!python_moveit_interface__srv__PoseRequest_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          python_moveit_interface__srv__PoseRequest_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!python_moveit_interface__srv__PoseRequest_Request__copy(
...
python_moveit_interface__srv__PoseRequest_Response__init(python_moveit_interface__srv__PoseRequest_Response * msg)
{
  ...
  // message
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    python_moveit_interface__srv__PoseRequest_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  python_moveit_interface__srv__PoseRequest_Response * msg = (python_moveit_interface__srv__PoseRequest_Response *)allocator.allocate(sizeof(python_moveit_interface__srv__PoseRequest_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(python_moveit_interface__srv__PoseRequest_Response));
  bool success = python_moveit_interface__srv__PoseRequest_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
python_moveit_interface__srv__PoseRequest_Response__Sequence__init(python_moveit_interface__srv__PoseRequest_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  python_moveit_interface__srv__PoseRequest_Response * data = NULL;

  if (size) {
    data = (python_moveit_interface__srv__PoseRequest_Response *)allocator.zero_allocate(size, sizeof(python_moveit_interface__srv__PoseRequest_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = python_moveit_interface__srv__PoseRequest_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        python_moveit_interface__srv__PoseRequest_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
python_moveit_interface__srv__PoseRequest_Response__Sequence__fini(python_moveit_interface__srv__PoseRequest_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      python_moveit_interface__srv__PoseRequest_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  python_moveit_interface__srv__PoseRequest_Response__Sequence * array = (python_moveit_interface__srv__PoseRequest_Response__Sequence *)allocator.allocate(sizeof(python_moveit_interface__srv__PoseRequest_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = python_moveit_interface__srv__PoseRequest_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
python_moveit_interface__srv__PoseRequest_Response__Sequence__destroy(python_moveit_interface__srv__PoseRequest_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    python_moveit_interface__srv__PoseRequest_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
python_moveit_interface__srv__PoseRequest_Response__Sequence__are_equal(const python_moveit_interface__srv__PoseRequest_Response__Sequence * lhs, const python_moveit_interface__srv__PoseRequest_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!python_moveit_interface__srv__PoseRequest_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  python_moveit_interface__srv__PoseRequest_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(python_moveit_interface__srv__PoseRequest_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    python_moveit_interface__srv__PoseRequest_Response * data =
      (python_moveit_interface__srv__PoseRequest_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!python_moveit_interface__srv__PoseRequest_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          python_moveit_interface__srv__PoseRequest_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!python_moveit_interface__srv__PoseRequest_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
