...
#include "python_moveit_interface/srv/detail/gripper_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const python_moveit_interface::srv::GripperControl_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  python_moveit_interface::srv::GripperControl_Request & ros_message)
{
  // Member: close
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = python_moveit_interface::srv::GripperControl_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const python_moveit_interface::srv::GripperControl_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<python_moveit_interface::srv::GripperControl_Request *>(
    untyped_ros_message);
...
{
  return &python_moveit_interface::srv::typesupport_fastrtps_cpp::_GripperControl_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, python_moveit_interface, srv, GripperControl_Request)() {
  return &python_moveit_interface::srv::typesupport_fastrtps_cpp::_GripperControl_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_python_moveit_interface
cdr_serialize(
  const python_moveit_interface::srv::GripperControl_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  python_moveit_interface::srv::GripperControl_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = python_moveit_interface::srv::GripperControl_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const python_moveit_interface::srv::GripperControl_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<python_moveit_interface::srv::GripperControl_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &python_moveit_interface::srv::typesupport_fastrtps_cpp::_GripperControl_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, python_moveit_interface, srv, GripperControl_Response)() {
  return &python_moveit_interface::srv::typesupport_fastrtps_cpp::_GripperControl_Response__handle;
}
...
{
  return &python_moveit_interface::srv::typesupport_fastrtps_cpp::_GripperControl__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, python_moveit_interface, srv, GripperControl)() {
  return &python_moveit_interface::srv::typesupport_fastrtps_cpp::_GripperControl__handle;
}
