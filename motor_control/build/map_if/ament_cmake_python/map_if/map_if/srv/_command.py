...
class Metaclass_Command_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('map_if')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Command(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from map_if.srv import _command
...
class Command(metaclass=Metaclass_Command):
    from map_if.srv._command import Command_Request as Request
    from map_if.srv._command import Command_Response as Response
