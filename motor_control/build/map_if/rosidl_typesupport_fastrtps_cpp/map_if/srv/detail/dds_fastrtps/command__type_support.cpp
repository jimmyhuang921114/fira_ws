...
#include "map_if/srv/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = map_if::srv::Command_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const map_if::srv::Command_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<map_if::srv::Command_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_map_if
const rosidl_message_type_support_t *
get_message_type_support_handle<map_if::srv::Command_Request>()
{
  return &map_if::srv::typesupport_fastrtps_cpp::_Command_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = map_if::srv::Command_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const map_if::srv::Command_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<map_if::srv::Command_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &map_if::srv::typesupport_fastrtps_cpp::_Command_Response__handle;
}
...
{
  return &map_if::srv::typesupport_fastrtps_cpp::_Command__handle;
}
